...
Test Results
============
**Commit:** e9b3be8c5cb66dd09704c968ba628a9d008529cc  
...
### Mandatory Full Simulation Tests (7/20)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
### Simulation Component Tests (15/25)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
| GoPickItUp2 | ❌ (FAILURE) | Tests a task for collecting garbage. |  
...
| CleanItUp | ❌ (FAILURE) | Tests plastic collection with single ship. |  
...
| PickMeUp | ❌ (FAILURE) | Tests default behavior of collecting ships. |  
