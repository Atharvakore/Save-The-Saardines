...
Test Results
============
**Commit:** 3d0fe7c8221d474646ede86edee4ef637b043ae9  
...
### Mandatory Simulation Component Tests (30/60)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
| IGuessWeAreCollectingNow | ☠ (SERVER_FAIL) | Tests a collect task for a scouting ship. |  
| PartialIKnowWhatYouDid | ☠ (SERVER_FAIL) | Tests reward distribution. |  
...
| TheyreTakingTheHobbits | ⏰ (TIMEOUT) | Tests the interaction between different events. |    
...
| ExploreMapTaskTest | ❌ (FAILURE) | tests Scheduling of events |  
| CorpNoMove1Test | ❌ (FAILURE) | test not moving collecting ships when no garbage visible |  
...
| CoordinatingTest | ❌ (FAILURE) | test moving to tile with ship in FoV |    
...
### Simulation Component Tests (13/25)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
