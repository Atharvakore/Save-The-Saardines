...
Test Results
============
**Commit:** 0e746b45a879288f165eca060e60a2446a6d551f  
...
### Mandatory Full Simulation Tests (4/20)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
| StormEvent | ❌ (FAILURE) | Tests storm event. |  
| Stowaway | ❌ (FAILURE) | Tests invalid corporation properties. |  
...
| TopLinePerformer | ❌ (FAILURE) | Tests constraints for currents. |  
...
| DriftHigher | ❌ (FAILURE) | Tests drifting of garbage. |  
| DriftLower | ❌ (FAILURE) | Scenario of garbage drift to lower id tile |  
...
| FindYou | ❌ (FAILURE) | Tests default behavior of collecting ships. |  
...
| NoNeedForBeachCleanUp | ❌ (FAILURE) | Tests drifting of garbage. |  
...
| SomebodyStoleMyGarbage | ❌ (FAILURE) | Tests pirate event on statistics. |  
