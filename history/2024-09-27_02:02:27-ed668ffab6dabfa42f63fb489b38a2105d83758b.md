...
Test Results
============
**Commit:** ed668ffab6dabfa42f63fb489b38a2105d83758b  
...
### Mandatory Simulation Component Tests (37/60)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
### Mandatory Full Simulation Tests (8/20)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
### Simulation Component Tests (16/25)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
| YouCanOnlyGetThis | ❌ (FAILURE) | Tests interplay between ship behavior and events. |    
...
| NoTimeToSayGoodbye | ❌ (FAILURE) | Tests unloading at harbor. |  
...
| RiffleShuffle | ✅ (SUCCESS) | Tests id ordering for different types of logs. |  
