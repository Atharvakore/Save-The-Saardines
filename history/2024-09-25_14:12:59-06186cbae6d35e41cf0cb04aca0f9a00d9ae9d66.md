...
Test Results
============
**Commit:** 06186cbae6d35e41cf0cb04aca0f9a00d9ae9d66  

group19  

## MANDATORY TESTS
### Mandatory Validation Tests (18/19)
...
| WaitingToBeClaimed | ⏰ (TIMEOUT) | Tests the mapping between harbors and corporations. |  
...
| CleaningTheAir | ⏰ (TIMEOUT) | Tests collect task without garbage. |  
...
| LetMeOut | ☠ (SERVER_FAIL) | Tests ship behavior inside a restricted area. |  
...
### Mandatory Full Simulation Tests (6/20)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
| TaskTest | ❌ (FAILURE) | tests Task Assignment and Working |  
| harbor with no corp | ✅ (SUCCESS) | harbor not belonging to any corp |  
| DriftALL | ❌ (FAILURE) | Test drifting of garbage and ships to multiple tiles |    
...
### Simulation Component Tests (11/25)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
