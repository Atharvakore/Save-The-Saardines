...
Test Results
============
**Commit:** a4c731201f424b503847d978f8cea0cc945853c4  
...
### Mandatory Simulation Component Tests (22/60)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
...
| ExampleTest | ✅ (SUCCESS) | two tasks with same ID |  
| ExampleTest | ✅ (SUCCESS) | two tasks with same ID |  
| ExampleTest | ✅ (SUCCESS) | two tasks with same ID |  
| ExampleTest | ✅ (SUCCESS) | two tasks with same ID |    
...
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
| AntContainer | ❌ (FAILURE) | Tests if garbage has an id property. |  
...
| SuperContainer | ❌ (FAILURE) | Tests if a reward has only allowed properties. |  
...
| UnstalkableGarbage | ❌ (FAILURE) | Tests if garbage has all the required properties. |  
...
### Full Simulation Tests (9/33)
|   Test  |  Result  | Description |  
| :------ | :------: | :---------- |  
| Afloat | ❌ (FAILURE) | Tests drifting of ships. |  
| BridgeRequired | ❌ (FAILURE) | Tests default behavior if garbage not reachable. |  
