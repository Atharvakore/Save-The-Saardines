...
class OilSpillTest {
    ...
    public fun testBasicCurrentTickIsNotFireTick() {
        val oilSpillEvent = OilSpill(1, 5, sea, DeepOcean(0, Vec2D(3, 5), emptyList(), mutableListOf(), null), 1, 500)
        ...
        val oilSpillEvent2 = OilSpill(1, 5, sea, DeepOcean(0, Vec2D(3, 5), emptyList(), mutableListOf(), null), 1, 500)
        ...
        val oilSpillEvent3 = OilSpill(1, 5, sea, DeepOcean(0, Vec2D(3, 5), emptyList(), mutableListOf(), null), 1, 500)
