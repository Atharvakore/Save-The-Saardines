...
class GarbageTest {
    ...
    fun setUp() {
        ...
        val tile4: DeepOcean = DeepOcean(4, Vec2D(1, 1), emptyList(), emptyList(), Current(10, Direction.D0, 1))
    ...
    fun garbageDriftToNull() {
        val currentTile: Tile? = seaInstance.getTileById(4)
        ...
        garbage.drift(
            ...
            (currentTile as DeepOcean).getCurrent()!!
        )
