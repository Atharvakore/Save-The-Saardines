 ...
 * example system test
 */
class NewTestCollectMoreThanOneShip : ExampleSystemTestExtension() {
    override val description = "TestsCollect"
    override val corporations = "collectTest/collectTestCorp.json"
    override val scenario = "collectTest/scenarioCollectTest.json"
    override val map = "mapFiles/smallMap1.json"
    override val name = "New Test Collect More Ships More Garbage"
    override val maxTicks = 1
    override suspend fun run() {
        assertNextLine("Initialization Info: smallMap1.json successfully parsed and validated.")
        assertNextLine("Initialization Info: collectTestCorp.json successfully parsed and validated.")
        assertNextLine("Initialization Info: scenarioCollectTest.json successfully parsed and validated.")
