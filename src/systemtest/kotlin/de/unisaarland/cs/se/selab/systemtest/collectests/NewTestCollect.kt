 ...
 * example system test
 */
class NewTestCollect : ExampleSystemTestExtension() {
    override val description = "TestsCollect"
    override val corporations = "collectTest/collectTestCorp2.json"
    override val scenario = "scenarioJsons/scenarioCollectPlastic.json"
    override val map = "mapFiles/smallMap1.json"
    override val name = "NewTestCollect"
    override val maxTicks = 1
    override suspend fun run() {
        assertNextLine("Initialization Info: smallMap1.json successfully parsed and validated.")
        assertNextLine("Initialization Info: collectTestCorp2.json successfully parsed and validated.")
        assertNextLine("Initialization Info: scenarioCollectPlastic.json successfully parsed and validated.")
