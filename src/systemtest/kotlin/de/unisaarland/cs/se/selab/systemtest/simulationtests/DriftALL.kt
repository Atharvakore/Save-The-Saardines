...
class DriftALL : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("Current Drift: OIL 1 with amount 150 drifted from tile 9 to tile 1.")
        ...
        assertNextLine("Corporation Action: Corporation 1 is starting to cooperate with other corporations.")
        skipLines(2)
        assertNextLine("Current Drift: PLASTIC 3 with amount 150 drifted from tile 9 to tile 1.")
        skipLines(3)
    }
}
