 ...
 * example system test
 */
class NewTestTrackGarbage : ExampleSystemTestExtension() {
    override val description = "TrackedGarbage" /*
    override val corporations = "corporationJsons/corporations.json"
    override val scenario = "scenarioJsons/scenario.json"
    override val map = "mapFiles/smallMap1.json"*/

    override val corporations = "corporationJsons/trackedGarbageCorp.json"
    override val scenario = "scenarioJsons/trackedGarbageScenario.json"
    override val map = "mapFiles/smallMap1.json"
    override val name = "NewTestTrackGarbage"
    override val maxTicks = 1
    override suspend fun run() {
        assertNextLine("Initialization Info: smallMap1.json successfully parsed and validated.")
        assertNextLine("Initialization Info: trackedGarbageCorp successfully parsed and validated.")
        assertNextLine("Initialization Info: trackedGarbageScenario.json successfully parsed and validated.")
