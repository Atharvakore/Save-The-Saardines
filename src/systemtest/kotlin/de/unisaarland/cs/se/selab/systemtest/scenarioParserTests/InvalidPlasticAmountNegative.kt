 ...
 * example system test
 */
class InvalidPlasticAmountNegative : ExampleSystemTestExtension() {
    override val description = "invalid plastic Amount which is negative"
    override val corporations = "corporationJsons/corporations.json"
    override val scenario = "scenarioJsons/invalidScenario/plasticAmountNegative.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("Initialization Info: plasticAmountNegative.json is invalid.")
    }
}
