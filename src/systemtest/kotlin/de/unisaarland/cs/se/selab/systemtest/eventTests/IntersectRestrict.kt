 ...
 */
class IntersectRestrict : ExampleSystemTestExtension() {
    ...
    override val scenario = "scenarioJsons/intersectingRestriction.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("Initialization Info: intersectingRestriction.json successfully parsed and validated.")
